...
public class ZoneDeInteres {
	...
	// Declaring a variable called locatie, which is a string, and two variables called latitudine and longitudine, which are
	// doubles.
	String locatie;
	...
	// A constructor. It is a special method that is used to initialize a newly created object and is called just after the
